<?php include "header.php"; ?>
	...
	<div class="row">
		...
		<div class="col-lg-2 col-md-6 tooltip2" id="search_by_cif">
			...
			<span class="tooltiptext" id="ket_regional" style="display: block;">
				Masukkan CIF Sesuai Regional.
			</span>

			<span class="tooltiptext" id="ket_cabang" style="display: none;">
				Masukkan CIF Sesuai Cabang.
			</span>

			<span class="tooltiptext" id="ket_unit" style="display: none;">
				Masukkan CIF Sesuai Unit.
			</span>
	...
	<div class="col-12">
		...
		<div class="tab-content">
			...
			<div role="tabpanel" class="tab-pane" id="customer_360">
				<?php include "customer_360_1.php" ?>
			</div>
		</div>
	</div>
