	...
	<div class="row col-lg-12" style="padding-right: 0; margin-top: 20px;">
		<div class="col-lg-12" style="padding-right: 0;">
			...
			<div class="col-lg-1 col-md-2 mb-2" id="reset_button" style="float: right;">
				<button class="btn btn-custom" type="button" style="width: 100%;" onclick="resetPencarianKRCredit()">
					<span class="text">Reset</span>
				</button>
			</div>

			<div class="col-lg-2 col-md-6 mb-2" style="float: right;">
				<select class="form-control bg-light border-cus small" id="search_by_periode" onchange="pilihPeriodeTP()">
		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body">
					...
					<table class="table table-striped table-bordered" id="tabel-data-c1" cellspacing="0">
						...
						<tbody>
							<tr>
								<td>
									<a class="btn btn-outline-primary font-weight-bold" href="#" data-toggle="modal" data-target="#pie_nasabah">VAR6736213</a>
								</td>
								...
								<td>2019-09-21</td>
								<td align="center">
									<a class="btn btn-outline-danger" href="#" data-toggle="modal" data-target="#pie3_prediction">Interpretasi Prediksi</a>
								</td>
							</tr>
						</tbody>
					</table>
	...
	<div class="modal fade" id="pie_nasabah" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
 		<div class="modal-dialog modal-lg" role="document" style="max-width: 750px">
 			<div class="modal-content">
 				<div class="modal-header" style="background-color: #EF7A48;">
 					<h5 class="modal-title judul">DETAIL DATA CALON DEBITUR</h5>
 					<button class="close" type="button" data-dismiss="modal" aria-label="Close">
 					...
 					<div class="row mb-4">
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_nik">6171012358378884</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_no_aplikasi">VAR6736213</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_branch">Unit Batujajar Cimahi</td>
 								</tr>
 							</table>
 						</div>
 					</div>
 					...
 					<div class="row mb-4">
 						<div class="col-lg-4">
 							<table width="100%">
 								<tr>
 									<td valign="top" width="13%">
 										<i class="fas fa-user-edit" style="font-size: 16px; color: #EE2E29;"></i>
 									</td>
 									<td style="font-size: .85em; font-family: 'Lucida Console';">Nama Pegawai</td>
 								</tr>
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_officer">Cr_Ciburuy-Officer_1</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								<tr>
 									<td valign="top" width="13%">
 										<i class="fas fa-calendar-day" style="font-size: 16px; color: #EE2E29;"></i>
 									</td>
 									<td style="font-size: .85em; font-family: 'Lucida Console';">Tanggal</td>
 								</tr>
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_tanggal">21 September 2019</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_agama">ISLAM</td>
 								</tr>
 							</table>
 						</div>
 					</div>
 					...
 					<div class="row mb-4">
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_umur">29 Tahun</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_jenis_kelamin">Laki - laki</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_pendidikan">S1</td>
 								</tr>
 							</table>
 						</div>
 					</div>
 					...
 					<div class="row mb-4">
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_status_kawin">Lajang</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_sumber_dana">Gaji Kerja</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_pekerjaan">Buruh Pabrik</td>
 								</tr>
 							</table>
 						</div>
 					</div>
 					...
 					<div class="row mb-4">
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_bidang_usaha">LAINNYA</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_jenis_usaha">LAINNYA</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_penghasilan">Rp 24,800,000</td>
 								</tr>
 							</table>
 						</div>
 					</div>
 					...
 					<div class="row mb-4">
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_jenis_loan">KREDIT REKENING KORAN</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_plafond">Rp 288,000,000</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_tenor">24 Bulan</td>
 								</tr>
 							</table>
 						</div>
 					</div>
 					...
 					<div class="row mb-4">
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_angsuran">Rp 12,000,000</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_bunga">10%</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_jenis_jaminan">BPKB</td>
 								</tr>
 							</table>
 						</div>
 					</div>
 					...
 					<div class="row mb-4">
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_nilai_jaminan">Rp 50,000,000</td>
 								</tr>
 							</table>
 						</div>
 					</div>
