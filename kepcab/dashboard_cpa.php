...
<div class="row mb-4" style="margin-top: 10px;">
	<div class="col-lg-5 col-xs-12">
		<div class="row">
			<div class="col-lg-6 col-md-6 col-xs-12" id="search_by_unit">
				<span style="color: #000;">Wilayah</span>
				<input class="form-control bg-light border-cus small" style="margin-top: 5px;" list="unitList" id="unit" placeholder="Pilih Unit" onchange="pilihUnit()" autocomplete="off">
			...
			<div class="col-lg-6 col-md-6 col-xs-12 mb-2 d-none" id="search_by_officer">
				<br>
	...
	<div class="col-lg-1 mb-2" id="reset_button">
		<br>
		<button class="btn btn-custom" type="button" style="width: 100%; margin-top: 5px;" onclick="resetPencarianCPAKC()">
