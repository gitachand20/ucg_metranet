...
<div class="row mb-4" style="margin-top: 10px;">
	<div class="row col-lg-7 col-xs-12">
		<div class="col-lg-4 col-md-4 col-xs-12 mb-2" id="search_by_cabang">
			<span style="color: #000;">Wilayah</span>
			<input class="form-control bg-light border-cus small" onchange="pilihCabang()" list="cabangList" id="cabang" placeholder="Pilih Cabang" style="margin-top: 5px;" autocomplete="off">
		...
		<div class="col-lg-4 col-md-4 col-xs-12 mb-2 d-none" id="search_by_unit">
			<br>
			<input class="form-control bg-light border-cus small" list="unitList" id="unit" placeholder="Pilih Unit" onchange="pilihUnit()" style="margin-top: 5px;" autocomplete="off">
		...
		<div class="col-lg-4 col-md-4 col-xs-12 mb-2 d-none" id="search_by_officer">
			<br>
			<input class="form-control bg-light border-cus small" list="officerList" id="search_officer" placeholder="Pilih Officer" style="margin-top: 5px;" autocomplete="off">
			<datalist id="officerList">
				<option data-id="1" value="abcdefghijklmnopqrst"></option>
	...
	<div class="col-lg-4 col-xs-12" style="border-left: 0.25rem solid #BDBDBD !important; margin-left: 1rem; padding-left: 1.5rem;">
		<div class="row justify-content-center">
			<div class="col-lg-4 col-sm-4 col-xs-12">
				<span style="color: #000;">Jangka Waktu</span>
				<select class="form-control select bg-light border-cus small" style="margin-top: 5px; padding-left: 0.25rem;" name="filter_month" id="filter_month">
			...
			<div class="col-lg-4 col-sm-4 col-xs-12">
				<br>
				<select class="form-control select bg-light border-cus small" style="margin-top: 5px; padding-left: 0.25rem" name="year" id="year">
			...
			<div class="col-lg-4 col-sm-4 col-xs-12">
				<br>
				<select class="form-control select bg-light border-cus small" style="margin-top: 5px; padding-left: 0.25rem" name="filter_period" id="filter_period">
	...
	<div class="col-lg-1 mb-2" id="reset_button">
		<br>
		<button class="btn btn-custom" type="button" style="width: 100%; margin-top: 5px;" onclick="resetPencarianCPAKR()">
