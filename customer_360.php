		...
		<div class="col-lg-6">
			<div class="card shadow mb-4">
				<div class="card-header py-3" style="background-color: #00FF00;">
                  	<h6 class="m-0 font-weight-bold" style="color: #000;"><b>DEMOGRAPH</b></h6>
                </div>
                <div class="card-body">
	...
	<div class="row">
		<div class="col-lg-6">
			<div class="card shadow mb-4">
				...
				<div class="card-header py-3" style="background-color: #00FFFF;">
					<h6 class="m-0 font-weight-bold" style="color: #000;"><i class="fas fa-fw fa-chart-area"></i>&nbsp;<b>CHANNEL BEHAVIOUR</b></h6>
				</div>
		...
		<div class="col-lg-6">
			<div class="card shadow mb-4">
				<!-- Card Header - Accordion -->
				<div class="card-header py-3" style="background-color: #00FFFF;">
					<h6 class="m-0 font-weight-bold" style="color: #000;"><i class="fas fa-fw fa-chart-area"></i>&nbsp;<b>FINANCIAL USAGE FREQUENCY</b></h6>
				</div>
				<!-- Card Content - Collapse -->
	...
	<div class="row">
		<div class="col-lg-6">
			<div class="card shadow mb-4">
				<!-- Card Header - Accordion -->
				<div class="card-header py-3" style="background-color: #00FFFF;">
					<h6 class="m-0 font-weight-bold" style="color: #000;"><i class="fas fa-fw fa-table"></i>&nbsp;<b>TRANSACTION HISTORY</b></h6>
				</div>
				<!-- Card Content - Collapse -->
		...
		<div class="col-lg-6">
			<div class="card shadow mb-4">
				<!-- Card Header - Accordion -->
				<div class="card-header py-3" style="background-color: #00FFFF;">
					<h6 class="m-0 font-weight-bold" style="color: #000;"><i class="fas fa-fw fa-chart-area"></i>&nbsp;<b>FINANCIAL USAGE AMOUNT</b></h6>
				</div>
				<!-- Card Content - Collapse -->
