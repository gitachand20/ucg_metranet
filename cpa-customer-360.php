<?php include "header.php"; ?>
	...
	<div class="row">
		<div class="col-lg-7 col-md-12 d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800">Customer Profiling Analysis - Customer 360</h1>
		</div>
			...
			<div class="col-lg-4 col-md-12" style="margin-top: 10px;">
				<div class="card shadow">
					...
					<div class="card-body">
						<br>
						<center>
							<i class="fa fa-star fa-7x" style="color: #F5DA81;"></i>
						</center>
						<br>
						<center>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<ul style="list-style-position: outside;">
						<li>VIP : Kelompok nasabah yang menghasilkan 20% current value.</li>
						<li>Non - VIP : Kelompok nasabah yang menghasilkan 80% current value.</li>
					</ul>
					<hr>
