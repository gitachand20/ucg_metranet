<?php include "header.php"; ?>
	...
	<div class="row">
		<div class="col-lg-12 mb-4">
			...
			<form name="form_input_debitur" id="form_input_debitur" method="POST" action="hasil.php" enctype="multipart/form-data" autocomplete="off" novalidate>
				...
				<!-- Form Data Diri -->
				<fieldset id="form-1" style="display: block; height: 355px; overflow: auto; overflow-x: hidden;">
					<div class="row" style="margin-top: 5px;">
						...
						<div class="row col-lg-10">
							...
							<div class="row col-lg-9 col-xs-12 mb-3" style="padding-right: 0;">
								...
								<div class="col-lg-4">
									<input class="form-control data-diri" type="text" name="nama_tengah" id="nama_tengah" placeholder="Nama Tengah" onkeypress="return alphaOnly(event)" autocomplete="off">
									<div class="invalid-feedback">
					...
					<div class="row">
						<div class="col-lg-1"></div>
						<div class="row col-lg-10">
							<label class="col-lg-3 col-xs-12 col-form-label labelku">Email <sup style="color: #FF0000; font-weight: bold;">*</sup></label>
							<div class="col-lg-9 col-xs-12 mb-3">
								<input class="form-control data-diri" type="text" name="email" id="email" placeholder="Email" autocomplete="new-text" onchange="cekEmail()">
								<div class="invalid-feedback">
				...
				<fieldset id="form-2" style="display: none; height: ; overflow: auto; overflow-x: hidden;">
					...
					<fieldset id="form-2-usaha" style="display: none;">
						...
						<div class="row">
							...
							<div class="row col-lg-10">
								<label class="col-lg-3 col-xs-12 col-form-label labelku">Jenis Usaha <sup style="color: #FF0000; font-weight: bold;">*</sup></label>
								<div class="col-lg-9 col-xs-12 mb-3">
									<select class="form-control sp-all" name="jenis_usaha" id="jenis_usaha" onchange="setJenisUsaha()" style="border-color: ; background-color: ;">
										<option value="" disabled="disabled" selected="selected">Pilih Opsi</option>
										<option value="Perdagangan">Perdagangan</option>
										<option value="Jasa">Jasa</option>
										<option value="Manufaktur">Manufaktur</option>
					...
					<fieldset id="omset-usaha-jasa" style="display: none;">
						<div class="row">
							...
							<div class="row col-lg-10">
								...
								<div class="row col-lg-9 col-xs-12 mb-3" style="padding-right: 0;">
									<div class="col-lg-3">
										<input class="form-control sp-all" type="text" name="cek_omset_usaha_jasa" id="cek_omset_usaha_jasa" placeholder="Rp" onchange="hitungOmsetJasa()">
										<div class="invalid-feedback">
											Omset Usaha tidak boleh kosong.
										</div>
									</div>
									...
									<div class="col-lg-3">
										<input class="form-control sp-all" type="text" name="omset_usaha_jasa" id="omset_usaha_jasa" placeholder="Rp" readonly>
									</div>
					...
					<fieldset id="laba-kotor" style="display: none;">
						<div class="row">
							...
							<div class="row col-lg-10">
								...
								<div class="col-lg-9 col-xs-12 mb-3">
									<input class="form-control sp-all" type="text" name="laba_kotor" id="laba_kotor" placeholder="Rp" readonly>
									<div class="invalid-feedback">
					...
					<fieldset id="form-2-usaha-pertanian" style="display: none;">
						<div class="row">
							...
							<div class="row col-lg-10">
								...
								<div class="col-lg-9 col-xs-12 mb-3">
									<input class="form-control sp-all" type="text" name="harga_komoditi" id="harga_komoditi" placeholder="Rp" onchange="hitungOmsetPertanian()">
									<div class="invalid-feedback">
						...
						<div class="row">
							...
							<div class="row col-lg-10">
								...
								<div class="col-lg-9 col-xs-12 mb-3">
									<input class="form-control sp-all" type="text" name="hasil_panen" id="hasil_panen" placeholder="Kg" onkeypress="return isNumber(event)" onchange="hitungOmsetPertanian()">
									<div class="invalid-feedback">
						...
						<div class="row">
							<div class="col-lg-1"></div>
							<div class="row col-lg-10">
								<label class="col-lg-3 col-xs-12 col-form-label labelku">Omset Usaha</label>
								<div class="col-lg-9 col-xs-12 mb-3">
						...
						<div class="row">
							<div class="col-lg-1"></div>
							<div class="row col-lg-10">
								<label class="col-lg-3 col-xs-12 col-form-label labelku">Pengalaman Panen <sup style="color: #FF0000; font-weight: bold;">*</sup></label>
								<div class="col-lg-9 col-xs-12 mb-3">
									<input class="form-control sp-all" type="text" name="pengalaman_panen" id="pengalaman_panen" placeholder="Berapa Kali">
									<div class="invalid-feedback">
						...
						<div class="row">
							<div class="col-lg-1"></div>
							<div class="row col-lg-10">
								<label class="col-lg-3 col-xs-12 col-form-label labelku">Biaya Tenaga Kerja Borongan <sup style="color: #FF0000; font-weight: bold;">*</sup></label>
								<div class="col-lg-9 col-xs-12 mb-3">
						...
						<div class="row">
							<div class="col-lg-1"></div>
							<div class="row col-lg-10">
								<label class="col-lg-3 col-xs-12 col-form-label labelku">Biaya Sewa</label>
								<div class="col-lg-9 col-xs-12 mb-3">
									<input class="form-control" type="text" name="biaya_sewa_pertanian" id="biaya_sewa_pertanian" placeholder="Rp">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-1"></div>
							<div class="row col-lg-10">
								<label class="col-lg-3 col-xs-12 col-form-label labelku">Biaya Rumah Tangga</label>
								<div class="col-lg-9 col-xs-12 mb-3">
									<input class="form-control" type="text" name="biaya_rt_pertanian" id="biaya_rt_pertanian" placeholder="Rp">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-1"></div>
							<div class="row col-lg-10">
								<label class="col-lg-3 col-xs-12 col-form-label labelku">GPM</label>
								<div class="col-lg-9 col-xs-12 mb-3">
									<input class="form-control" type="text" name="gpm_pertanian" id="gpm_pertanian" placeholder="Rp">
								</div>
							</div>
						</div>
					...
					<fieldset id="sarana-prasarana" style="display: none;">
						<div class="row">
							<div class="col-lg-1"></div>
							<div class="row col-lg-10">
								<label class="col-lg-3 col-xs-12 col-form-label labelku">Sarana dan Prasarana Usaha <sup style="color: #FF0000; font-weight: bold;">*</sup></label>
								<div class="col-lg-9 col-xs-12 mb-3">
				...
				<fieldset id="form-3" style="display: none; height: 355px; overflow: auto; overflow-x: hidden;">
					<div class="row" style="margin-top: 5px;">
						<div class="col-lg-1"></div>
						<div class="row col-lg-10">
				...
				<!-- Form Data Jaminan -->
				<fieldset id="form-4" style="display: none; height: 315px; overflow: auto; overflow-x: hidden;">
							...
							<table width="100%">
								<tr>
									<td align="right">
										...
										<input type="button" id="btnNext4" class="btn btn-custom-dis" onclick="selanjutnya4()" value="Selanjutnya" >
									</td>
								</tr>
							</table>
						</div>
				...
				<!-- Form Unggah Berkas -->
				<fieldset id="form-5" style="display: none; height: 330px; overflow: auto; overflow-x: hidden;">
					<!-- Data Diri -->
					<div class="row mb-3">
						<div class="col-lg-1"></div>
						<div class="col-lg-10">
							...
							<table width="100%">
								<tr>
									<td align="right">
										...
										<input type="submit" id="btnFinish" class="btn btn-custom-dis" name="simpan" value="Selesai" >
									</td>
								</tr>
							</table>
						</div>
	...
	<script id="draft_berkas_jaminan" type="text/x-handlebars-template">
		<div class="row col-lg-12 berkas-jaminan">
			<label class="col-lg-3 col-xs-12 col-form-label"><span class="label_jenis_jaminan"></span> <sup style="color: #FF0000; font-weight: bold;">*</sup></label>
			<div class="col-lg-9 col-xs-12 mb-2">
				<div class="custom-file">
					Unggah
					<input type="file" class="custom-file-input berkas-kepemilikan-jaminan" name="berkas_kepemilikan_jaminan[]" value={{ berkas_kepemilikan_jaminan }} required>
					<label class="custom-file-label label-kepemilikan-jaminan" for="berkas_kepemilikan_jaminan"></label>
					<div class="invalid-feedback-custom" id="file_error_kepemilikan_jaminan" style="margin-top: -10px; display: none;"></div>
					<div class="invalid-feedback" id="invalid_kepemilikan_jaminan" style="margin: -10px 0 0 0;">
						File Jaminan tidak boleh kosong.
					</div>
				</div>
			</div>
		</div>
	...
	<!-- <script id="draft_jaminan" type="text/x-handlebars-template">
		<tr class="hapus_list_jaminan" id="hapus_list_jaminan">
			<td>
				<table width="100%">
					<tr>
						<td width="25%" class="labelku">Jenis Jaminan</td>
						<td width="75%">
							<input class="form-control" type="text" name="jenis_jaminan[]" value="@{{ jenis_jaminan }}" readonly>
						</td>
					</tr>
					...
					<tr>
						<td class="labelku">Bukti Kepemilikan Jaminan</td>
						<td>
							<input class="form-control" type="text" name="bukti_jaminan[]" value="@{{ bukti_jaminan }}" readonly>
						</td>
					</tr>
					...
					<tr>
						<td class="labelku">Alamat Jaminan</td>
						<td>
							<input class="form-control" type="text" name="alamat_jaminan[]" value="@{{ alamat_jaminan }}" readonly>
						</td>
					</tr>
					...
					<tr>
						<td class="labelku">Nomor Bukti Kepemilikan</td>
						<td>
							<input class="form-control" type="text" name="no_bukti_kepemilikan[]" value="@{{ no_bukti_kepemilikan }}" readonly>
						</td>
					</tr>
					...
					<tr>
						<td class="labelku">Luas Tanah</td>
						<td>
							<input class="form-control" type="text" name="luas_tanah[]" value="@{{ luas_tanah }}" readonly>
						</td>
					</tr>
					...
					<tr>
						<td class="labelku">Luas Bangunan</td>
						<td>
							<input class="form-control" type="text" name="luas_bangunan[]" value="@{{ luas_bangunan }}" readonly>
						</td>
					</tr>
					...
					<tr>
						<td class="labelku">Izin Mendirikan Bangunan (IMB)</td>
						<td>
							<input class="form-control" type="text" name="imb[]" value="@{{ imb }}" readonly>
						</td>
					</tr>
					...
					<tr>
						<td class="labelku">Tahun Pembelian</td>
						<td>
							<input class="form-control" type="text" name="tahun_pembelian[]" value="@{{ tahun_pembelian }}" readonly>
						</td>
					</tr>
					...
					<tr>
						<td class="labelku">Nilai Jaminan</td>
						<td>
							<input class="form-control" type="text" name="nilai_jaminan[]" value="@{{ nilai_jaminan }}" readonly>
						</td>
					</tr>
					...
					<tr>
						<td class="labelku">Tindakan</td>
						<td>
							<button id="hapus_jaminan" class="btn btn-custom" onclick="hapusJaminan()">
								<span class="icon1 text-white">
									<i class="fas fa-trash-alt"></i>
								</span>
							</button>
