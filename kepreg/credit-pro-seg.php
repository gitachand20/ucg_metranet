	...
	<div class="row col-lg-12" style="padding-right: 0; margin-top: 20px;">
		<div class="col-lg-12" style="padding-right: 0;">
			<div class="col-lg-2 col-md-4 mb-2" id="search_by_loan_nik_seg" style="float: left;">
			...
			<div class="input-group col-1 mb-2" id="reset_button_seg" style="float: right;">
				<button class="btn btn-custom" type="button" style="width: 100%;" onclick="resetPencarianKRCreditSeg()">
			...
			<div class="col-lg-2 col-md-6 mb-2 d-none" id="search_by_unit_seg" style="float: right;">
			...
			<div class="col-lg-2 col-md-6 mb-2" id="search_by_cabang_seg" style="float: right;">
				<input class="form-control bg-light border-cus small" onchange="pilihCabangSeg()" list="cabangListSeg" id="cabang_seg" placeholder="Pilih Cabang" autocomplete="off">
				<datalist id="cabangListSeg">
	...
	<div class="row">
		<div class="col-lg-5 col-md-12 mb-4">
			<div class="card">
				...
				<div class="card-body">
					<iframe class="d-block w-100" src="http://172.17.62.84:3000/public/question/c13cb13c-bc76-45ff-a9b7-a45c238876ea" frameborder="0" width="100%" height="500" allowtransparency></iframe>
				</div>
			</div>
		</div>
		...
		<div class="col-lg-7 col-md-12 mb-4">
			<div class="card">
				...
				<div class="card-body">
					<iframe class="d-block w-100" src="http://172.17.62.84:3000/public/question/fcacfad3-a548-4dbf-b2bb-c2c9411acbf6" frameborder="0" width="100%" height="500" allowtransparency></iframe>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-lg-12 mb-4">
			<div class="card">
				...
				<div class="card-body">
					<iframe class="d-block w-100" src="http://172.17.62.84:3000/public/question/2b87f006-e9ca-4620-b5fd-0b18ec568a44" frameborder="0" width="100%" height="700" allowtransparency></iframe>
				</div>
			</div>
		</div>
	</div>
