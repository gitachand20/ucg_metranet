<?php include "header.php"; ?>
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">
			<a href="ka_hasil_analisis.php" class="btn btn-back">
				<i class="fas fa-arrow-left text-lg"></i>
			</a>
			Form Input Debitur Kredit Analisis
		</h1>
	</div>
				...
				<div class="card-body row">
					<div class="col-lg-3">
						...
						<div id="menu_4" class="col-lg-12 mb-2">
							<div id="label_menu_4" style="padding: 0.375rem 0.75rem; font-size: 1rem; display: block;">
								Data Jaminan
							</div>

							<button id="btn_menu_4" class="btn btn-menu" onclick="setDataJaminan()" style="display: none;">
								Data Jaminan
							</button>
						</div>
    ...
    <!-- Set Value -->
    <script src="form_analyst/set_value.js"></script>
