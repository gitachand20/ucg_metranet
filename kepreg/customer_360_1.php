			...
			<div class="col-lg-2 col-md-12">
				<form action="#" method="post">
					<div class="input-group">
						<input class="form-control border-cus" type="text" name="cari" placeholder="Cari CIF" autocomplete="off" required>
						<div class="input-group-append">
							<button class="btn btn-detail" type="button" onclick="spinner()">
					...
					<!-- <div class="form-group row">
						<div class="col-8">
							<input class="form-control" type="text" name="cari" placeholder="Cari CIF" required>
						</div>
						<div class="col-4">
							<input class="btn btn-custom" type="submit" name="btn_cari" value="Cari" onclick="spinner()" style="width: 100%;">
						</div>
					</div> -->
				</form>
			</div>

			<div class="col-lg-10 col-md-12 d-none" id="fitur" style="float: right;">
					...
					<div class="col-lg-6 col-md-12">
						<div class="form-group row">
							<div class="col-lg-4 col-md-3 col-sm-3">
								<select class="form-control select filter-customer-360" name="filter_month" id="filter_month" onchange="spinner1()">
							...
							<div class="col-lg-4 col-md-3 col-sm-3">
								<select class="form-control select filter-customer-360" name="year" id="year">
							...
							<div class="col-lg-4 col-md-3 col-sm-3">
								<select class="form-control select filter-customer-360" name="filter_period" id="filter_period">
							...
							<span style="margin-left: 12px; margin-top: 5px; font-size: 10pt; font-weight: bold; color: #ff0000;">Isi Filter Untuk Menampilkan Detail Data</span>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-4 col-md-12" style="margin-top: 10px;">
				<div class="card shadow">
					...
					<div class="card-body">
						<iframe class="d-block w-100" src="http://172.17.62.84:3000/public/question/927b88d2-a205-432f-805a-ff7d9a5396dd" frameborder="0" width="100%" height="400" allowtransparency></iframe>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-12" style="margin-top: 10px;">
				<div class="card shadow">
					...
					<div class="card-body">
						<iframe class="d-block w-100" src="http://172.17.62.84:3000/public/question/69bab6f6-23e4-4ab2-8bd0-1071b8ad83b3" frameborder="0" width="100%" height="400" allowtransparency></iframe>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-12" style="margin-top: 10px;">
				<div class="card shadow">
					...
					<div class="card-body">
						<iframe class="d-block w-100" src="http://172.17.62.84:3000/public/question/567bcc4b-50da-4c8f-8c7b-59f21d6d4bc3" frameborder="0" width="100%" height="400" allowtransparency></iframe>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-6 col-md-12" style="margin-top: 10px;">
				<div class="card shadow">
					<div class="card-body" style="padding-top: 5px;">
						<table class="mb-3" width="100%" style="color: #000;">
						...
						<table class="mb-3" width="100%" style="color: #000;">
							<tr style="border-bottom: 2px #000 solid; margin-bottom: 5px;">
								<td width="60%">
									<span class="m-0 font-weight-bold" style="font-size: 1.2rem;"><b>Profil Berdasarkan Status Usia</b></span>
								</td>
								<td width="40%">
									<span style="font-size: 1.2rem;">Married Professional</span>
								</td>
							</tr>
						</table>

						<table class="mb-2" width="100%" style="color: #000;">
							<tr style="border-bottom: 2px #000 solid;">
								<td width="60%">
									<span class="m-0 font-weight-bold" style="font-size: 1.2rem;"><b>Status Perkawinan</b></span>
								</td>
								<td width="40%">
									<span style="font-size: 1.2rem;">Online Loyalist</span>
								</td>
							</tr>	
						</table>
					</div>
				...
				<div class="card shadow">
					...
					<div class="card-header1 py-1" style="background-color: #FFE8D3;">
						<div class="form-group1 row">
							...
							<div class="col-4">
								<a href="#" class="btn1 btn-outline-warning font-weight-bold" data-toggle="modal" data-target="#curent_value" style="float: right;">Detail</a>
							</div>
						</div>
					</div>
					<div class="card-body">
						<iframe class="d-block w-100" src="http://172.17.62.84:3000/public/question/9237cb8e-7fe1-4109-aaed-52fb7f8539fd" frameborder="0" width="100%" height="300" allowtransparency></iframe>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-12" style="margin-top: 10px;">
				<div class="card shadow">
					...
					<div class="card-body">
						<iframe class="d-block w-100" src="http://172.17.62.84:3000/public/question/be5b88d1-66bb-4a68-ba1e-d24a8d96202f" frameborder="0" width="100%" height="500" allowtransparency></iframe>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="modal-dialog modal-lg" role="document"> <!-- style="max-width: 1140px" -->
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- <div class="row">
						<div class="col-lg-5">
							<iframe class="d-block w-100" src="http://172.17.62.87:3000/public/question/f0b78f17-6321-4f58-aeb5-ff8cd000dd7c" frameborder="0" width="100%" height="400"    allowtransparency></iframe>
						</div>		
						<div class="col-lg-7">
							<iframe class="d-block w-100" src="http://172.17.62.84:3000/public/question/9931788a-8966-43a5-82bd-836c6713c9f9" frameborder="0" width="100%" height="400" allowtransparency></iframe>
						</div>				
					</div> -->
					<iframe class="d-block w-100" src="http://172.17.62.84:3000/public/question/9931788a-8966-43a5-82bd-836c6713c9f9" frameborder="0" width="100%" height="400" allowtransparency></iframe>
					<hr>
