<?php include "header.php"; ?>
	...
	<div class="sk-circle d-none" id="load" style="margin-top: 5%;">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12" style="margin-top: 10px;">
				<div class="card shadow">
					...
					<div class="card-body">
						<iframe class="d-block w-100" src="http://172.17.62.84:3000/public/question/9237cb8e-7fe1-4109-aaed-52fb7f8539fd" frameborder="0" width="100%" height="400" allowtransparency></iframe>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-12" style="margin-top: 10px;">
				<div class="card shadow">
					...
					<div class="card-body">
						<iframe class="d-block w-100" src="http://172.17.62.84:3000/public/question/be5b88d1-66bb-4a68-ba1e-d24a8d96202f" frameborder="0" width="100%" height="600" allowtransparency></iframe>
					</div>
				</div>
			</div>
		</div>
