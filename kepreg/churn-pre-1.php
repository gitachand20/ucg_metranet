...
?>
	...
	<style type="text/css">
		...
		.progress-circle.high .progress-left .progress-bar-val {
		    animation: loading-high 3s linear forwards 1.6s;
		}
		...
		.progress-circle.medium .progress-left .progress-bar-val {
		    animation: loading-med 3s linear forwards 1.6s;
		}
		...
		.progress-circle.low .progress-left .progress-bar-val {
		    animation: loading-low 3s linear forwards 1.6s;
		}
	</style>
	...
	<div class="row col-lg-12 mb-3" style="padding-right: 0;">
		<div class="col-lg-12" style="padding-right: 0;">
			<div class="col-lg-2 col-md-6 mb-2" id="search_by_loan_nik" style="float: left;">
				<input class="form-control bg-light border-cus small filter-behavior-prediction" id="cif_behavior_seg"  list="cifList" name="cif_behavior_seg" placeholder="Cari CIF" aria-label="Search" aria-describedby="basic-addon2" onchange="setCif()" autocomplete="off">
				<datalist id="cifList">
				</datalist>
			</div>
	...
	<!-- <div class="row mb-3">
		<div class="col-lg-1-cus col-md-6 mb-2" id="search_by_loan_nik">
			<input class="form-control bg-light border-cus small filter-behavior-prediction" id="cif_behavior_seg"  list="cifList" name="cif_behavior_seg" placeholder="Cari CIF" aria-label="Search" aria-describedby="basic-addon2" onchange="setCif()" autocomplete="off">
			<datalist id="cifList">
			</datalist>
		</div>

		<div class="row col-lg-10-cus d-sm-flex justify-content-end" style="padding-right: 0;">
			<div class="col-lg-2-cus col-md-6 mb-2" id="search_by_cabang" style="padding-right: 0;">
				<input class="form-control bg-light border-cus small" onchange="pilihCabang()" list="cabangList" id="cabang" placeholder="Pilih Cabang" autocomplete="off">
				<datalist id="cabangList">
					<option value="CABANG 1"></option>
					<option value="CABANG 2"></option>
			...
			<div class="col-lg-2-cus col-md-6 mb-2 d-none" id="search_by_unit" style="padding-right: 0;">
				<input class="form-control bg-light border-cus small" list="unitList" id="unit" placeholder="Pilih Unit" onchange="pilihUnit()" autocomplete="off">
				<datalist id="unitList">
					<option value="UNIT 1"></option>
					<option value="UNIT 2"></option>
			...
			<div class="col-lg-2-cus col-md-6 mb-2 d-none" id="search_by_officer" style="padding-right: 0;">
				<input class="form-control bg-light border-cus small" list="officerList" id="search_officer" placeholder="Pilih Officer" autocomplete="off">
				<datalist id="officerList">
					<option data-id="1" value="Officer 1"></option>
					<option data-id="2" value="Officer 2"></option>
			...
			<div class="col-lg-1 col-md-6 mb-2" id="search_by_year" style="padding-right: 0;">
				<select class="form-control bg-light border-cus small" style="padding: 0.375rem 0.25rem;" name="year" id="year" onchange="pilihTahun()">
					<option value="" disabled="disabled" selected="selected">Tahun</option>
					<option value="2020">2020</option>
					<option value="2019">2019</option>
					<option value="2018">2018</option>
			...
			<div class="col-lg-2-cus col-md-6 mb-2" id="search_by_month" style="padding-right: 0;">
				<select class="form-control bg-light small" name="filter_month" id="filter_month" disabled="disabled">
					<option value="" disabled="disabled" selected="selected">Bulan</option>
					<option value="01">Januari</option>
					<option value="02">Februari</option>
			...
			<div class="col-lg-1 col-md-6 mb-2" id="reset_button" style="padding-right: 0;">
				<button class="btn btn-custom" type="button" style="width: 100%;" onclick="resetPencarianKRChurn()">
					<span class="text">Reset</span>
				</button>
			</div>
		</div>
	...
	<div class="row mb-4">
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body">
					<div class="row col-lg-12 d-sm-flex justify-content-end">
						<div class="col-lg-2 mb-2">
							<input class="form-control bg-light border-warning small" id="search_rekening" placeholder="Cari Rekening" autocomplete="off">
						</div>

						<div class="col-lg-2 mb-2">
							<select class="form-control bg-light border-warning small" id="search_prediction">
								<option value="" selected="selected">Prediksi</option>
								<option value="churn">Churn</option>
								<option value="not churn">Not Churn</option>
							</select>
						</div>

						<div class="col-lg-2 mb-2">
							<select class="form-control bg-light border-warning small" id="search_risk_level">
								<option value="" selected="selected">Level Risiko</option>
					...
					<table class="table table-striped table-bordered" id="tabel-churn" cellspacing="0">
						...
						<tbody>
							<tr>
								<td>
									<a class="btn btn-outline-primary font-weight-bold" href="#" data-toggle="modal" data-target="#pie_nasabah">118773226</a>
								</td>
								<td>CAC57640</td>
								<td>Jan, 2019</td>
								<td>
			...
			<div class="card">
				<div class="card-header">
					<div class="row">
						...
						<div class="col-lg-2 col-md-4" id="search_by_rekening" style="margin: auto;">
							<input class="form-control bg-light small" id="rekening_churn"  list="rekeningList" name="rekening_churn" placeholder="Pilih Rekening" aria-label="Search" aria-describedby="basic-addon2" disabled="disabled" autocomplete="off" style="background-color: #fff;">
							<datalist id="rekeningList">
								<option value="Rekening 1"></option>
								<option value="Rekening 2"></option>
								<option value="Rekening 3"></option>
								<option value="Rekening 4"></option>
							</datalist>
						</div>
					</div>
				</div>
				<div class="card-body">
					<table class="table table-striped table-bordered" id="tabel-churn-1" cellspacing="0">
						<thead style="text-align: center;">
							<tr>
								<th>Rekening</th>
								<th>CIF</th>
						...
						<tbody>
							<tr>
								...
								<td>Jan, 2019</td>
								<td>
									<span id="label_churn_1" class="label-churn d-none">Churn</span>
									<span id="label_not_churn_1" class="label-not-churn">Not Churn</span>
								</td>
								<td>
									<span id="level_low_1" class="level-low d-none">Low</span>
									<span id="level_medium_1" class="level-medium">Medium</span>
									<span id="level_high_1" class="level-high d-none">High</span>
								</td>
								<td>Gaji Pensiun</td>
								<td>Rp 9,200,000</td>
								<td>32</td>
									...
									<table width="100%">
										<tr>
											...
											<td align="right" colspan="2">
												<span id="detail_nama" class="text-primary font-weight-bold" style="font-size: 1.7rem;">Purnando Gita Chandra</span>
											</td>
										</tr>
										<tr>
											<td align="right">
												<span class="text-dark font-weight-bold" style="margin-right: 10px;">CIF :</span>
												<span id="detail_cif" class="text-primary">CAC57640</span>
											</td>
											<td align="right">
												<span class="text-dark font-weight-bold" style="margin-right: 10px;">Rekening :</span>
												<span id="detail_rekening" class="text-primary">118773226</span>
											</td>
										</tr>
									</table>
								</div>
					...
					<table width="100%">
						<tr>
							<td align="center" style="padding-bottom: 1rem;">
								<span style="color: #F02632; font-weight: bold;">3 Faktor yang paling mempengaruhi Churn :</span>
							</td>
						</tr>
						<tr>
							<td align="center" style="padding: 0.5rem 0rem;">
								<span class="faktor-lime margin">
									<sup class="sup-faktor-lime">1</sup>
									<span id="faktor_1" style="color: #000;">FQ6_CREDIT</span>
								</span>

								<span class="faktor-lime margin">
									<sup class="sup-faktor-lime">2</sup>
									<span id="faktor_2" style="color: #000;">FQ6_IB</span>
								</span>

								<span class="faktor-lime">
									<sup class="sup-faktor-lime">3</sup>
									<span id="faktor_3" style="color: #000;">FQ6_ATM</span>
								</span>
							</td>
						</tr>
					</table>
							...
							<div class="card shadow">
								<div class="card-body">
									<table width="100%">
										...
										<tr valign="bottom">
											<td align="center">
												<span id="lime_rekening" style="font-size: 1.2rem; color: #000;">118773226</span>
											</td>
										</tr>
									</table>
								</div>
	...
	<div class="modal fade" id="pie_lime1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document" style="max-width: 1140px">
			<div class="modal-content">
				<div class="modal-header" style="background-color: #FFA07A;">
					<h5 class="modal-title" id="exampleModalLabel" style="font-weight: bold; color: #000;">Interpretasi Prediksi</h5>
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-lg-4">
							<table width="100%">
								<tr>
									<td align="center" class="label-churn" style="color: #F02632; border-radius: 5px; margin-bottom: 1rem;">
										3 Faktor yang paling mempengaruhi Churn :
									</td>
								</tr>
								<tr>
									<td align="center" style="padding: 1rem 0rem;">
										<span class="faktor-lime">
											<sup class="sup-faktor-lime">1</sup>
											<span id="faktor_1" style="color: #000;">FQ6_CREDIT</span>
										</span>
	...
	<script type="text/javascript">
		...
		document.getElementById("icon_cp_pre_1").style.color = "#F02632";
		document.getElementById("name_cp_pre_1").style.color = "#F02632";		
	</script>
...
<?php include "footer.php"; ?>
	...
	<script type="text/javascript">
		window.onload = function() {
			...
			// $("#level_medium").removeClass("d-none");
			// $("#level_medium").show();

			// $("#level_low_1").removeClass("d-none");
			// $("#level_low_1").show();
		}
	</script>