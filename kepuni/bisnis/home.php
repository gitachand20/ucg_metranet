<?php include "header.php"; ?>
	...
	<div class="row col-lg-12 mb-3">
		<div class="col-lg-2 col-md-6 mb-2" id="search_by_officer">
			...
			<input class="form-control bg-light border-cus small" style="margin-top: 5px;" list="officerList" id="search_officer" placeholder="Pilih Officer" onchange="pilihOfficerKUB()" autocomplete="off">
		...
		<div class="col-1 mb-2" id="reset_button">
			<br>
			<button class="btn btn-custom" type="button" style="width: 100%; margin-top: 5px;" onclick="resetPencarianKUBHome()">
