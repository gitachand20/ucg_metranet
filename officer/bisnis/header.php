  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-white sidebar sidebar-light accordion toggled" id="accordionSidebar">
      ...
      <li class="nav-item" id="menu_cpa">
        <a class="nav-link" href="customer-360.php">
      ...
      <li class="nav-item" id="menu_bs">
        <a class="nav-link" href="behavior-pre.php">
          <i class="fas fa-fw fa-award" id="icon_bs" style="color: ;"></i>
          <span id="name_bs" style="color: ;">Behavior Scoring</span></a>
      </li>

      <!-- Nav Item - Churn Prevention -->
      <li class="nav-item" id="menu_cp">
        <a class="nav-link" href="churn-pre.php">
          <i class="fas fa-fw fa-refresh" id="icon_cp" style="color: ;"></i>
          <span id="name_cp" style="color: ;">Churn Prevention</span></a>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">OFFICER (BISNIS)</span>
