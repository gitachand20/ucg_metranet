	...
	<form name="form_input_unggah_berkas" class="needs-validation" method="POST" action="#" enctype="multipart/form-data" novalidate>
		...
		<fieldset class="p-1 mb-3" style="border: 2px solid #e3e6f0;">
			...
			<div class="row col-lg-12">
				...
				<div class="col-lg-1 col-xs-12 mb-2">
					<a href="#" id="v_ktp" target="_blank" class="btn btn-outline-info">
			...
			<div class="row col-lg-12">
				...
				<div class="col-lg-1 col-xs-12 mb-2">
					<a href="simpan/360.jpeg" target="_blank" class="btn btn-warning">
						<i class="fas fa-fw fa-file-alt"></i>
					</a>
				</div>
			</div>
		...
		<div class="form-group" style="float: right;">
			...
			<input type="submit" id="simpan_berkas" class="btn btn-custom-dis" name="simpan" value="Simpan" disabled="disabled">
		</div>
	</form>
</fieldset>
