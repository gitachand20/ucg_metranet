  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-white sidebar sidebar-light accordion toggled" id="accordionSidebar">
      ...
      <li class="nav-item" id="menu_cs">
        <a class="nav-link" href="credit-pre.php">
          <i class="fas fa-fw fa-tachometer-alt" id="icon_cs" style="color: ;"></i>
          <span id="name_cs" style="color: ;">Credit Risk Scoring</span></a>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">OFFICER (KREDIT)</span>
