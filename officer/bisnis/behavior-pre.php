<?php include "header.php"; ?>
	...
	<div class="row col-lg-12 mb-4" style="padding-right: 0;">
		<div class="col-lg-12" style="padding-right: 0;">
			...
			<div class="col-lg-1 col-md-6 mb-2" id="reset_button" style="float: right;">
				<button class="btn btn-custom" type="button" style="width: 100%;" onclick="resetPencarianOBBehavior()">
