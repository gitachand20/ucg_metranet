...
function selanjutnya1() {
	...
	document.querySelector(".f1-progress-line").style.width = "30%";
	...
	if (document.getElementById("sumber_penghasilan").value == "Gaji Kerja") {
		...
		document.getElementById("form-2").style.height = "355px";
		...
		document.getElementById("form-2").style.height = "315px";
...
function selanjutnya2() {
	...
	document.querySelector(".f1-progress-line").style.width = "50%";
...
function selanjutnya3() {
	...
	document.querySelector(".f1-progress-line").style.width = "70%";
...
function selanjutnya4() {
	document.querySelector("#page5").classList.add("active");
	document.querySelector(".f1-progress-line").style.width = "100%";
	document.getElementById("ket-5").style.color = "#F02632";
	document.getElementById("ket-51").style.color = "#F02632";
	document.getElementById("ket-unggah-berkas").style.display = "block";

	// console.log(document.getElementById("list_jaminan").value.length);
	...
	// console.log(jml_jaminan);

	document.getElementById("jml_jaminan").value = jml_jaminan;
		...
		for (var i = 0; i < jml_jaminan; i++) {
			document.getElementById("list_berkas_jaminan").insertAdjacentHTML("beforeend", 
	                '<div class="row col-lg-12 berkas-jaminan">' +
	                	'<label class="col-lg-3 col-xs-12 col-form-label">' +
	                		'<span style="font-size: 8pt;">Berkas Jaminan ' + (i + 1) + '</span><br>' +
	                		'<span>&nbsp;&nbsp;' + bkt_jaminan[i] + '</span>' + 
	                		' <sup style="color: #FF0000; font-weight: bold;">*</sup>' +
	                	'</label>' +
						'<div class="col-lg-9 col-xs-12 mb-2">' +
							'<div class="custom-file" style="margin-top: 15px;">' +
								'Unggah' +
								'<input type="file" class="custom-file-input berkas-kepemilikan-jaminan" id="berkas_kepemilikan_jaminan_' + i + '" name="berkas_kepemilikan_jaminan_' + i + '" accept="application/pdf, image/jpeg" required>' +
	...
	// for (var i = 0; i < jml_jaminan; i++) {
	// 	var berkas_kepemilikan_jaminan = "";
	// 	var source = $("#draft_berkas_jaminan").html();
	// 	var template = Handlebars.compile(source);

	// 	var data = {
	// 		berkas_kepemilikan_jaminan: berkas_kepemilikan_jaminan
	// 	}

	// 	var html = template(data);

	// 	$("#list_berkas_jaminan").append(html);
	// }


	// var label_jaminan = document.getElementsByClassName("label_jenis_jaminan");
	// for (var i = 0; i < jml_jaminan; i++) {
	// 	label_jaminan[i].textContent = bkt_jaminan[i];
	// }
}

function sebelumnya1() {
	document.querySelector("#page2").classList.remove("active");
	document.querySelector(".f1-progress-line").style.width = "10%";
...
function sebelumnya4() {
	document.querySelector("#page5").classList.remove("active");
	document.querySelector(".f1-progress-line").style.width = "70%";
	document.getElementById("ket-5").style.color = "#ddd";
	document.getElementById("ket-51").style.color = "#ddd";
	document.getElementById("ket-unggah-berkas").style.display = "none";
...
// var values = $("input[name='harga_beli[]']").map(function(){return $(this).val();}).get();
// console.log(values);
// var harga_beli1 = document.getElementsByName("harga_beli[]");
// console.log(harga_beli1);
// for (var i = 0; i < harga_beli1.length; i++) {
// 	console.log("test");
// }

// function printDetails(i) {
//   	console.log("Clicked " + harga_beli1[i].value);
// }

// function cekHargaBeli() {
// 	var harga_beli1 = document.getElementsByName("harga_beli[]");
// 	for (var i = 0; i < harga_beli1.length; i++) {
// 		console.log(harga_beli1[i].value);
// 	}
// }
...
function check_dataDiri() {
	...
	if (nama_depan != "" && nama_tengah != "" && nama_belakang != "" && nama_ibu != "" && nik != "" 
		...
		&& alamat_ktp != "" && alamat_domisili != "" && no_hp != "" && email != "" && status_tempat_tinggal != "" 
...
function check_sumberPenghasilan() {
	...
	var pengalaman_panen = $("#pengalaman_panen").val();
	...
	if (sp == "Gaji Kerja") {
		...
		if (jenis_usaha == "Perdagangan") {
			...
			if (nama_perusahaan != "" && level_usaha != "" && alamat_perusahaan != "" && no_telp_perusahaan != "" 
				&& website_perusahaan != "" && tahun_usaha != "" && bulan_usaha != "" && status_tempat_usaha != "" 
				&& jumlah_karyawan != "" && omset_usaha != "" && hpp != "" && laba_kotor_gpm != "" && gaji_karyawan != "" 
			...
			if (nama_perusahaan != "" && level_usaha != "" && alamat_perusahaan != "" && no_telp_perusahaan != "" 
				&& website_perusahaan != "" && tahun_usaha != "" && bulan_usaha != "" && status_tempat_usaha != "" 
				&& jumlah_karyawan != "" && harga_komoditi != "" && hasil_panen != "" && pengalaman_panen != "" 
				&& luas_lahan != "" && biaya_pupuk != "" && biaya_tk != "" && channel_penjualan != "" 
				&& cara_bayar != "" && piutang_usaha != "" && utang_usaha != "" && utang_bank != "" 
				&& sarana_prasarana != "") {
...
// 
// ENABLE TOMBOL SELANJUTNYA => FINISH

$(document).ready(function(){
	$(".custom-file-input").bind("change", check_berkas);
});

function check_berkas() {
	var status_perkawinan = $("status_perkawinan").val();
	var berkas_ktp = $("#berkas_ktp").val();
	var berkas_akta_kelahiran = $("#berkas_akta_kelahiran").val();
	var berkas_akta_nikah = $("#berkas_akta_nikah").val();
	var berkas_kk = $("#berkas_kk").val();
	var berkas_ijazah = $("#berkas_ijazah").val();
	var berkas_slip_gaji = $("#berkas_slip_gaji").val();
	var berkas_penghasilan_tambahan_gaji = $("#berkas_penghasilan_tambahan_gaji").val();
	var berkas_siup = $("#berkas_siup").val();
	var berkas_ho = $("#berkas_ho").val();
	var berkas_npwp = $("#berkas_npwp").val();
	var berkas_akta_pendirian = $("#berkas_akta_pendirian").val();
	var berkas_lap_keuangan = $("#berkas_lap_keuangan").val();
	var berkas_rekening_koran = $("#berkas_rekening_koran").val();
	var berkas_kepemilikan_lahan = $("#berkas_kepemilikan_lahan").val();
	var berkas_biaya_sewa = $("#berkas_biaya_sewa").val();
	var berkas_biaya_rt = $("#berkas_biaya_rt").val();
	var berkas_nota_penjualan = $("#berkas_nota_penjualan").val();
	var berkas_tagihan = $("#berkas_tagihan").val();
	var berkas_penghasilan_tambahan = $("#berkas_penghasilan_tambahan").val();
	var berkas_rab = $("#berkas_rab").val();
	var berkas_kepemilikan_jaminan = $("#berkas_kepemilikan_jaminan").val();

	// var set_index = "";
	// var berkas_jaminan = [];
	// for (var i = 0; i < jml_jaminan; i++) {
	// 	set_index = "berkas_kepemilikan_jaminan_" + i;
	// 	berkas_jaminan[i] = $(set_index).val();
	// }

	// console.log(berkas_jaminan);

	if (sp == "Gaji Kerja") {
		if (status_perkawinan == "Menikah") {
			if (pt_gk) {
				if (berkas_ktp != "" && berkas_akta_kelahiran != "" && berkas_akta_nikah != "" && berkas_kk != "" && berkas_ijazah != "" && berkas_slip_gaji != "" && berkas_penghasilan_tambahan_gaji != "") {
					$("#btnFinish").removeAttr("disabled");
					document.getElementById("btnFinish").classList.remove("btn-custom-dis");
					document.getElementById("btnFinish").classList.add("btn-custom-ad");
				} else {
				...
				if (berkas_ktp != "" && berkas_akta_kelahiran != "" && berkas_akta_nikah != "" && berkas_kk != "" && berkas_ijazah != "" && berkas_slip_gaji != "") {
					$("#btnFinish").removeAttr("disabled");
					document.getElementById("btnFinish").classList.remove("btn-custom-dis");
					document.getElementById("btnFinish").classList.add("btn-custom-ad");
				} else {
			...
			if (pt_gk) {
				if (berkas_ktp != "" && berkas_akta_kelahiran != "" && berkas_kk != "" && berkas_ijazah != "" && berkas_slip_gaji != "" && berkas_penghasilan_tambahan_gaji != "") {
					$("#btnFinish").removeAttr("disabled");
					document.getElementById("btnFinish").classList.remove("btn-custom-dis");
					document.getElementById("btnFinish").classList.add("btn-custom-ad");
				} else {
				...
				if (berkas_ktp != "" && berkas_akta_kelahiran != "" && berkas_kk != "" && berkas_ijazah != "" && berkas_slip_gaji != "") {
					$("#btnFinish").removeAttr("disabled");
					document.getElementById("btnFinish").classList.remove("btn-custom-dis");
					document.getElementById("btnFinish").classList.add("btn-custom-ad");
				} else {
		...
		if (document.getElementById("jenis_usaha").value == "Perdagangan") {
			if (status_perkawinan == "Menikah") {
				if (pt_hu) {
					if (document.getElementById("jenis_kredit_pro").value == "Kredit Investasi") {
						if (berkas_ktp != "" && berkas_akta_kelahiran != "" && berkas_akta_nikah != "" && berkas_kk != "" && berkas_ijazah != ""
							&& berkas_siup != "" && berkas_ho != "" && berkas_npwp != "" && berkas_akta_pendirian != ""
							&& berkas_lap_keuangan != "" && berkas_biaya_sewa != "" && berkas_biaya_rt != ""
							&& berkas_nota_penjualan != "" && berkas_tagihan != "" 
							&& berkas_penghasilan_tambahan_gaji != "" && berkas_rab != "") {
						...
						if (berkas_ktp != "" && berkas_akta_kelahiran != "" && berkas_akta_nikah != "" && berkas_kk != "" && berkas_ijazah != "" 
							...
							&& berkas_lap_keuangan != "" && berkas_biaya_sewa != "" && berkas_biaya_rt != ""
							&& berkas_nota_penjualan != "" && berkas_tagihan != "" 
							&& berkas_penghasilan_tambahan_gaji != "") {
					...
					if (document.getElementById("jenis_kredit_pro").value == "Kredit Investasi") {
						if (berkas_ktp != "" && berkas_akta_kelahiran != "" && berkas_akta_nikah != "" && berkas_kk != "" && berkas_ijazah != ""
							&& berkas_siup != "" && berkas_ho != "" && berkas_npwp != "" && berkas_akta_pendirian != ""
							&& berkas_lap_keuangan != "" && berkas_biaya_sewa != "" && berkas_biaya_rt != ""
							&& berkas_nota_penjualan != "" && berkas_tagihan != "" && berkas_rab != "") {
				...
				if (pt_hu) {
					if (document.getElementById("jenis_kredit_pro").value == "Kredit Investasi") {
						if (berkas_ktp != "" && berkas_akta_kelahiran != "" && berkas_kk != "" && berkas_ijazah != ""
							&& berkas_siup != "" && berkas_ho != "" && berkas_npwp != "" && berkas_akta_pendirian != ""
							&& berkas_lap_keuangan != "" && berkas_biaya_sewa != "" && berkas_biaya_rt != ""
							&& berkas_nota_penjualan != "" && berkas_tagihan != "" 
							&& berkas_penghasilan_tambahan_gaji != "" && berkas_rab != "") {
			...
			if (status_perkawinan == "Menikah") {
				if (pt_hu) {
					if (document.getElementById("jenis_kredit_pro").value == "Kredit Investasi") {
						if (berkas_ktp != "" && berkas_akta_kelahiran != "" && berkas_akta_nikah != "" && berkas_kk != "" && berkas_ijazah != ""
							&& berkas_siup != "" && berkas_ho != "" && berkas_npwp != "" && berkas_akta_pendirian != ""
							&& berkas_lap_keuangan != "" && berkas_rekening_koran != "" && berkas_kepemilikan_lahan != ""
							&& berkas_nota_penjualan != "" && berkas_tagihan != ""
							&& berkas_penghasilan_tambahan_gaji != "" && berkas_rab != "") {
