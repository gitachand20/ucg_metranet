<?php include "header.php"; ?>
	...
	<div class="row col-lg-12 mb-3" style="padding-right: 0;">
		<div class="col-lg-12" style="padding-right: 0; padding-left: 0;">
			<div class="col-lg-2 col-md-6 mb-2" id="search_by_unit" style="float: left;">
			...
			<div class="col-lg-2 col-md-6 mb-2 d-none" id="search_by_officer" style="float: left;">
				<br>
				<input class="form-control bg-light border-cus small" style="margin-top: 5px;" list="officerList" id="search_officer" placeholder="Pilih Officer" autocomplete="off" onchange="pilihOfficerKC()">
			...
			<div class="col-1 mb-2" id="reset_button" style="float: right;">
				<br>
				<button class="btn btn-custom" type="button" style="width: 100%; margin-top: 5px;" onclick="resetPencarianKCHome()">
