	...
	<div class="row mb-4">
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body">
					<table class="table table-striped table-bordered" id="tabel-data-pro1" cellspacing="0">
						<thead style="text-align: center;">
							<tr>
								<th>No Aplikasi</th>
								<th>Branch</th>
	...
	<!-- MODAL -->
	<!-- Prediksi Performansi Calon Debitur -->
	<div class="modal fade" id="pie1_prediction" tabindex="-1" role="dialog" aria-hidden="true">
 					...
 					<div class="row mb-4">
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_penghasilan">Rp 10,000,000</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_plafond">Rp 30,000,000</td>
 								</tr>
 							</table>
 						</div>
 					</div>
 					...
 					<div class="row mb-4">
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_tenor">60 BULAN</td>
 								</tr>
 							</table>
 						</div>
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_angsuran">Rp 500,000</td>
 								</tr>
 							</table>
 						</div>
 					...
 					<div class="row mb-4">
 						...
 						<div class="col-lg-4">
 							<table width="100%">
 								...
 								<tr>
 									<td></td>
 									<td class="font-weight-bold" style="font-size: .85em; color: #000;" id="detail_kikmk">Rp 20,000,000</td>
 								</tr>
 							</table>
 						</div>
 					</div>
