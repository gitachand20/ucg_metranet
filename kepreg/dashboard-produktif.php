<?php include "header.php"; ?>
	...
	<div class="row">
		<div class="col-lg-12 col-md-12 d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800">Credit Risk Scoring - Dashboard Produktif</h1>
		</div>
	</div>
	...
	<div class="col-12">
		...
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane active" id="prediction">
				<?php include "credit-pro-pre.php"; ?>
			</div>

			<div role="tabpanel" class="tab-pane" id="segmentation">
				<?php include "credit-pro-seg.php"; ?>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		document.getElementById("icon_cs_pro").style.color = "#F02632";
		document.getElementById("name_cs_pro").style.color = "#F02632";
	</script>
